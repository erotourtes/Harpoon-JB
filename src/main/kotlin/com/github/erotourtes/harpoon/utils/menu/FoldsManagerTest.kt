...
class FoldsManagerTest {
    ...
    fun updateFoldsAt2() {
        ...
        val foldsManager = FoldsManager(
            projectInfo,
            foldingModel,
            FoldsManager.FoldsSettings(false, 3)
        )
        val folds = arrayOf(
    ...
    @Test
    @DisplayName("Shouldn't do anything")
    fun updateFoldsAt3() {
    ...
    @Test
    @DisplayName("Should update folds")
    fun updateFoldsAt4() {
        val path = "src/main/kotlin/com/example/MyClass.kt"
        val foldsManager = FoldsManager(
            projectInfo,
